...
export async function POST(request: Request) {
  try {
    ...
    const acompanhantesNomes = Array.isArray(body.acompanhantesNomes)
      ? body.acompanhantesNomes.filter(
    ...
    // URL de implantação Web App no Apps Script do Google Sheets
    const GOOGLE_SCRIPT_URL =
      process.env.GOOGLE_SCRIPT_URL ||
      "https://script.google.com/macros/s/AKfycbyc5BNI9Znty4fSjJz20Tk0Rzhq4kJj8kcLuPrWhilI_qxg7qI9heokO8gdzTnxxm1AWw/exec";
