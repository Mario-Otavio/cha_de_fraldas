    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-20 h-20 rounded-full bg-green-100/90 text-green-400 shadow-inner ring-1 ring-green-400/20 flex items-center justify-center mb-5"
            >
            ...
            <Button
                variant="outline"
                className="rounded-full px-6 cursor-pointer hover:bg-primary hover:text-white"
                onClick={onReset}
            >
